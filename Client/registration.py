...
def point2plane_registration_loss(source, target, distance_threshold, trans_init): 
...
def register_point_cloud_fpfh(source, target, source_fpfh, target_fpfh, voxel_size, odometry=False, color_mode = False):
    try:
        distance_threshold = voxel_size * 1.2
        icp_coarse = sac_ia_registration(source, target, source_fpfh, target_fpfh, voxel_size)
        icp_fine = 0
        if color_mode:
            icp_fine = color_registration(source, target, distance_threshold, icp_coarse.transformation)#point2plane_registration(source, target, distance_threshold, icp_coarse.transformation)
